...
qc <- readRDS("gadm/gadm41_CAN_1_pk.rds") |>
    st_as_sf() |>
    st_transform(32618) |>
    filter(NAME_1 == "Québec")
...
lakes <- st_read("data/ne_50m_lakes.shp") |>
    st_transform(32618)
...
beta_ls <- readRDS("data/COMPO_COMMU_betadiv_inventaire_terrestre_maj6MARS2026.rds")
...
beta_hab_ls <- readRDS("data/COMPO_COMMU_betadiv_inventaire_terrestre_per_habitat_maj6MARS2026.rds")
...
# varpart analysis
varpart_ls <- readRDS("data/LCBD_part_var_complete_results_maj28JANVIER2026.rds")[-c(19)]
...
varpart_hab_ls <- readRDS("data/part_var_complete_results_per_habitat_maj_28AVRIL2026.rds")
