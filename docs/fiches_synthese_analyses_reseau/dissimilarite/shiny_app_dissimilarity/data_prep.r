...
sites <- readRDS("data/sites_data_18JUIN2026.rds")
...
# ----- #
dat_ls <- readRDS("data/COMPO_COMMU_occ_inventaire_terrestre_maj28JANVIER2026.rds")
...
# data - matrix
mat_ls <- readRDS("data/COMPO_COMMU_matrices_inventaire_terrestre_maj28JANVIER2026.rds")
...
mat_hab_ls <- readRDS("data/COMPO_COMMU_matrices_inventaire_terrestre_per_habitat_maj28JANVIER2026.rds")
...
# data - beta
beta_ls <- readRDS("data/COMPO_COMMU_betadiv_inventaire_terrestre_maj28JANVIER2026.rds")
...
beta_hab_ls <- readRDS("data/COMPO_COMMU_betadiv_inventaire_terrestre_per_habitat_maj28JANVIER2026.rds")
...
# saveRDS(dissi_res_ls, "data/dissi_res_ls.rds")
dissi_res_ls <- readRDS("data/dissi_res_ls.rds")
